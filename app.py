...
["Environmental", "Unit 4", "Green data book kiske liye hai?", "Environmental data", "Endangered species,Environmental data,Animals,None"]
    ...
    ["IT System", "Unit 1: Hardware", "VGA port mein kitni pins hoti hain?", "15", "9,12,15,25"],
    ["IT System", "Unit 1: Basic", "SRAM mein 'S' ka kya matlab hai?", "Static", "Simple,Static,System,Speed"],
    ["IT System", "Unit 1: Hardware", "BIOS ki setting kahan save hoti hai?", "CMOS Chip", "RAM,CMOS Chip,Hard Disk,Monitor"],
    ["IT System", "Unit 2: OS", "Booting process ke samay pehla program kaunsa chalta hai?", "BIOS", "OS,BIOS,MS Word,Antivirus"],
    ["IT System", "Unit 2: OS", "Ek samay mein ek se zyada user kaam karein toh?", "Multi-user OS", "Single-user OS,Multi-user OS,Batch OS,None"],
    ["IT System", "Unit 2: OS", "File delete karne par permanent delete ki shortcut?", "Shift+Delete", "Delete,Shift+Delete,Ctrl+Delete,Alt+Delete"],
    ["IT System", "Unit 2: OS", "Task Manager kholne ki shortcut key?", "Ctrl+Shift+Esc", "Ctrl+Alt+Del,Ctrl+Shift+Esc,Alt+F4,None"],
    ["IT System", "Unit 2: OS", "Extension '.exe' kiske liye hota hai?", "Executable File", "Image File,Executable File,Document,System File"],
    ["IT System", "Unit 2: OS", "Disk Cleanup kya hai?", "Utility Tool", "OS,Utility Tool,Hardware,Virus"],
    ["IT System", "Unit 3: Word", "Ctrl+K shortcut se kya hota hai?", "Insert Hyperlink", "Insert Image,Insert Hyperlink,Clear Text,None"],
    ["IT System", "Unit 3: Word", "Default font size MS Word mein?", "11", "10,11,12,14"],
    ["IT System", "Unit 3: Word", "Ctrl+E se text kahan align hota hai?", "Center", "Left,Right,Center,Justify"],
    ["IT System", "Unit 3: Excel", "Excel mein aakhiri column ka naam?", "XFD", "ZZ,XFD,ABC,None"],
    ["IT System", "Unit 3: Excel", "Cell edit karne ki function key?", "F2", "F1,F2,F5,F7"],
    ["IT System", "Unit 3: PPT", "Slide transition kya hai?", "Slide badalne ka animation", "Text style,Slide badalne ka animation,Sound,None"],
    ["IT System", "Unit 3: Office", "Format Painter ki shortcut key?", "Ctrl+Shift+C", "Ctrl+C,Ctrl+Shift+C,Ctrl+V,None"],
    ["IT System", "Unit 4: Networking", "OSI Model mein kitni layers hoti hain?", "7", "4,5,7,9"],
    ["IT System", "Unit 4: Networking", "TCP ka full form?", "Transmission Control Protocol", "Transfer Control,Transmission Control Protocol,Total Control,None"],
    ["IT System", "Unit 4: Networking", "MAC Address kitne bits ka hota hai?", "48 bits", "32 bits,48 bits,64 bits,128 bits"],
    ["IT System", "Unit 4: Networking", "Bluetooth kaisa network hai?", "PAN", "LAN,MAN,WAN,PAN"],
    ["IT System", "Unit 4: Networking", "Star Topology mein central device?", "Hub or Switch", "Router,Hub or Switch,Server,Cable"],
    ["IT System", "Unit 4: Networking", "Data packets kis layer par kaam karte hain?", "Network Layer", "Physical Layer,Network Layer,Session Layer,None"],
    ["IT System", "Unit 4: Internet", "DNS ka kaam kya hai?", "Domain name ko IP mein badalna", "IP ko Domain mein badalna,Domain name ko IP mein badalna,Email bhejna,None"],
    ["IT System", "Unit 4: Internet", "SMTP protocol kiske liye use hota hai?", "Email sending", "File download,Email sending,Web browsing,None"],
    ["IT System", "Unit 4: Internet", "Pehla Search Engine kaunsa tha?", "Archie", "Google,Yahoo,Archie,Altavista"],
    ["IT System", "Unit 4: Internet", "IPv6 address kitne bits ka hota hai?", "128 bits", "32 bits,64 bits,128 bits,256 bits"],
    ["IT System", "Unit 5: Security", "Worm aur Virus mein kya antar hai?", "Worm khud ko copy karta hai", "Dono same hain,Worm khud ko copy karta hai,Virus fast hai,None"],
    ["IT System", "Unit 5: Security", "Encryption ka ulta process?", "Decryption", "Coding,Decryption,Hacking,None"],
    ["IT System", "Unit 5: Security", "SSL ka full form?", "Secure Sockets Layer", "Secure Sockets Layer,System Safe Layer,Social Site Link,None"],
    ["IT System", "Unit 5: Security", "Biometric lock ka example?", "Fingerprint", "Password,PIN,Fingerprint,None"],
    ["IT System", "Unit 5: Security", "Trojan Horse kya hai?", "Malware", "Hardware,Malware,Antivirus,Search Engine"],
    ["IT System", "Unit 5: Security", "Adware kya hai?", "Unwanted Ads dikhane wala software", "Virus,Unwanted Ads dikhane wala software,Browser,None"],
    ["IT System", "Unit 1: Basic", "Motherboard ke components ke beech data transfer?", "Bus", "Wire,Bus,Port,Slot"],
    ["IT System", "Unit 1: Basic", "1 Petabyte (PB) kiske barabar hai?", "1024 TB", "1024 GB,1024 TB,1024 MB,None"],
    ["IT System", "Unit 2: OS", "Open Source OS ka udaharan?", "Ubuntu", "Windows,Mac OS,Ubuntu,iOS"],
    ["IT System", "Unit 3: Word", "Subscript (H2O) ki shortcut key?", "Ctrl + =", "Ctrl + Shift + +,Ctrl + =,Alt + =,None"],
    ["IT System", "Unit 3: Word", "Superscript (X2) ki shortcut key?", "Ctrl + Shift + +", "Ctrl + =,Ctrl + Shift + +,Alt + P,None"],
    ["IT System", "Unit 4: Net", "FTP ka default port number?", "21", "20,21,80,443"],
    ["IT System", "Unit 4: Net", "Ping command ka use?", "Network connectivity check", "Download speed,Network connectivity check,IP delete,None"],
    ["IT System", "Unit 5: Sec", "Ransomware kya karta hai?", "Data lock karke paise mangna", "Virus hatana,Data lock karke paise mangna,Speed badhana,None"],
    ["IT System", "Unit 1: Adv", "CPU aur RAM ke beech fast memory?", "Cache", "Hard Disk,Cache,ROM,None"],
    ["IT System", "Unit 3: Excel", "Excel mein cell ko lock karne ka symbol?", "$", "#,$,&,*"],
    ["IT System", "Unit 2: OS", "System ko restart karne ki shortcut?", "Alt+F4 then Restart", "Alt+F4 then Restart,Ctrl+R,Shift+S,None"],
    ...
    ["IT System", "Unit 2: OS", "Task Manager kholne ki shortcut key kya hai?", "Ctrl+Shift+Esc", "Ctrl+Alt+Del,Ctrl+Shift+Esc,Alt+F4,Alt+Tab"],
    ["IT System", "Unit 2: OS", "Windows mein file search karne ki function key?", "F3", "F1,F2,F3,F5"],
    ["IT System", "Unit 2: OS", "Command Prompt (CMD) mein directory badalne ki command?", "cd", "dir,md,cd,rd"],
    ["IT System", "Unit 2: OS", "System ki properties check karne ki shortcut?", "Win + Pause/Break", "Win + D,Win + E,Win + Pause/Break,Win + L"],
    ["IT System", "Unit 2: OS", "Desktop par jaane ki shortcut key (Minimize all)?", "Win + D", "Win + D,Win + M,Alt + D,Ctrl + D"],
    ["IT System", "Unit 3: Word", "Font size badhane ki shortcut key?", "Ctrl + ]", "Ctrl + [,Ctrl + ],Ctrl + +,Ctrl + S"],
    ["IT System", "Unit 3: Word", "Document ke aakhir mein jaane ki shortcut?", "Ctrl + End", "Ctrl + End,Ctrl + Down,Alt + End,None"],
    ["IT System", "Unit 3: Word", "Page Break dalne ki shortcut key?", "Ctrl + Enter", "Alt + Enter,Ctrl + Enter,Shift + Enter,None"],
    ["IT System", "Unit 3: Excel", "Excel mein filter lagane ki shortcut?", "Ctrl+Shift+L", "Ctrl+F,Ctrl+Shift+L,Alt+F,None"],
    ["IT System", "Unit 3: Excel", "Active cell ka content kahan dikhta hai?", "Formula Bar", "Status Bar,Formula Bar,Menu Bar,Taskbar"],
    ["IT System", "Unit 3: Excel", "Column ko hide karne ki shortcut?", "Ctrl + 0", "Ctrl + 9,Ctrl + 0,Alt + H,None"],
    ["IT System", "Unit 3: PPT", "Slideshow beech mein se rokne ki key?", "ESC", "Enter,ESC,Shift,Ctrl"],
    ["IT System", "Unit 3: PPT", "Nayi presentation file banane ki shortcut?", "Ctrl + N", "Ctrl + M,Ctrl + N,Ctrl + O,Ctrl + S"],
    ["IT System", "Unit 4: Networking", "MAC address ko aur kya kehte hain?", "Physical Address", "Logical Address,Physical Address,IP Address,Virtual Address"],
    ["IT System", "Unit 4: Networking", "Data Link Layer par kaunsa device kaam karta hai?", "Switch", "Hub,Switch,Router,Repeater"],
    ["IT System", "Unit 4: Networking", "Twisted pair cable mein kitne wires hote hain?", "8 wires", "2 wires,4 wires,8 wires,10 wires"],
    ["IT System", "Unit 4: Networking", "Network speed 'Mbps' ka full form?", "Megabits per second", "Megabytes per second,Megabits per second,Main bits per second,None"],
    ["IT System", "Unit 4: Internet", "Web page design karne ke liye kaunsi language basic hai?", "HTML", "C++,Java,HTML,Python"],
    ["IT System", "Unit 4: Internet", "Browser mein 'Private Window' kholne ki shortcut?", "Ctrl+Shift+N", "Ctrl+N,Ctrl+P,Ctrl+Shift+N,Alt+N"],
    ["IT System", "Unit 4: Internet", "E-mail mein 'CC' ka full form?", "Carbon Copy", "Clear Copy,Carbon Copy,Computer Copy,None"],
    ["IT System", "Unit 4: Internet", "Cloud storage ka example kaunsa hai?", "Google Drive", "Hard Disk,Google Drive,RAM,ROM"],
    ["IT System", "Unit 5: Security", "Windows ka inbuilt antivirus kaunsa hai?", "Windows Defender", "Avast,Norton,Windows Defender,McAfee"],
    ["IT System", "Unit 5: Security", "Cyber crime ki reporting website?", "cybercrime.gov.in", "google.com,cybercrime.gov.in,itact.in,none"],
    ["IT System", "Unit 5: Security", "Encryption ka use kyun hota hai?", "Confidentiality", "Speed,Confidentiality,Storage,None"],
    ["IT System", "Unit 5: Security", "Phishing se bachne ka tarika?", "Check URL carefully", "Don't use internet,Check URL carefully,Use simple password,None"],
    ["IT System", "Unit 1: Basic", "Processor ki speed kis unit mein hoti hai?", "GHz", "GB,GHz,MB,Watts"],
    ["IT System", "Unit 1: Hardware", "Biometric sensor kaisa device hai?", "Input Device", "Input Device,Output Device,Storage Device,None"],
    ["IT System", "Unit 1: Basic", "1 Exabyte (EB) kiske barabar hai?", "1024 PB", "1024 TB,1024 PB,1024 GB,None"],
    ["IT System", "Unit 2: OS", "Disk defragmentation kyun karte hain?", "To optimize speed", "To delete files,To optimize speed,To install OS,None"],
    ["IT System", "Unit 3: Word", "Print Preview ki shortcut key?", "Ctrl + F2", "Ctrl + P,Ctrl + F2,Alt + P,None"],
    ["IT System", "Unit 3: Word", "Spelling aur Grammar check ki key?", "F7", "F1,F5,F7,F10"],
    ["IT System", "Unit 3: Excel", "Cell range ka example?", "A1:B10", "A1-B10,A1:B10,A1 to B10,None"],
    ["IT System", "Unit 4: Net", "Coaxial cable kahan use hoti hai?", "Cable TV", "Telephone,Cable TV,Ethernet,None"],
    ["IT System", "Unit 4: Net", "Internet par data kaise travel karta hai?", "Packets", "Blocks,Packets,Files,None"],
    ["IT System", "Unit 5: Sec", "Software ki unauthorized copy banana?", "Software Piracy", "Hacking,Software Piracy,Phishing,None"],
    ["IT System", "Unit 5: Sec", "Spyware ka kaam kya hai?", "Spying on user", "Deleting files,Spying on user,Speeding up PC,None"],
    ["IT System", "Unit 1: Basic", "CMOS battery ka life kitna hota hai?", "3-5 years", "1 year,3-5 years,10 years,None"],
    ["IT System", "Unit 2: OS", "Windows 10 mein 'Action Center' ki shortcut?", "Win + A", "Win + A,Win + C,Win + S,Win + X"],
    ["IT System", "Unit 3: Word", "Alignment kitne type ki hoti hai?", "4", "2,3,4,5"],
    ["IT System", "Unit 4: Net", "Pehla computer network?", "ARPANET", "Internet,ARPANET,NSFNET,None"],
    ["IT System", "Unit 1: Basic", "ALU aur CU milkar kya bante hain?", "CPU", "RAM,CPU,Motherboard,UPS"],
    ["IT System", "Unit 2: OS", "Post-booting screen ko kya kehte hain?", "Desktop", "Window,Desktop,Icon,Taskbar"],
    ["IT System", "Unit 3: Excel", "Row aur Column ke intersection ko kya kehte hain?", "Cell", "Block,Cell,Box,Grid"],
    ...
    ["ENV", "Unit 2: Pollution", "Vayu pr प्रदूषण (Air Pollution) ka mukhya karan?", "Burning of fossil fuels", "Planting trees,Burning of fossil fuels,Solar energy,Wind energy"],
    ["ENV", "Unit 2: Pollution", "Greenhouse effect ke liye mukhya gas?", "CO2", "O2,CO2,N2,Argon"],
    ["ENV", "Unit 2: Pollution", "Acid Rain (Amliya Varsha) ka karan?", "SO2 and NO2", "CO2,SO2 and NO2,Oxygen,Methane"],
    ["ENV", "Unit 3: Energy", "Renewable energy ka example?", "Solar Energy", "Coal,Petrol,Solar Energy,Natural Gas"],
    ["ENV", "Unit 3: Energy", "Non-renewable energy source kaunsa hai?", "Coal", "Solar,Wind,Coal,Hydro"],
    ["ENV", "Unit 4: Biodiversity", "World Environment Day kab manaya jata hai?", "5 June", "1 May,5 June,15 August,2 October"],
    ["ENV", "Unit 2: Pollution", "Noise pollution ki unit kya hai?", "Decibel (dB)", "Hertz,Decibel (dB),Meter,Joule"],
    ["ENV", "Unit 1: Ecosystem", "Energy ka primary source kya hai?", "Sun", "Moon,Sun,Plants,Animals"],
    ["ENV", "Unit 2: Pollution", "Water pollution se kaunsi bimari hoti hai?", "Typhoid", "Typhoid,Asthma,Diabetes,Hypertension"],
    ["ENV", "Unit 5: Rules", "Global Warming ka parinam kya ho sakta hai?", "Sea level rise", "More trees,Sea level rise,Clean air,None"],
    ["ENV", "Unit 2: Pollution", "Ozone layer kahan payi jati hai?", "Stratosphere", "Troposphere,Stratosphere,Mesosphere,None"],
    ["ENV", "Unit 2: Pollution", "Ozone layer humein kis se bachati hai?", "UV Rays", "X-Rays,UV Rays,Gamma Rays,Infrared"],
    ["ENV", "Unit 3: Energy", "LPG ka full form?", "Liquefied Petroleum Gas", "Low Petrol Gas,Liquefied Petroleum Gas,Liquid Pure Gas,None"],
    ["ENV", "Unit 2: Pollution", "Bhopal Gas Tragedy mein kaunsi gas leak hui thi?", "MIC", "CO,CO2,MIC,Chlorine"],
    ["ENV", "Unit 1: Ecosystem", "Khady shrunkhla (Food Chain) shuru hoti hai?", "Photosynthesis", "Photosynthesis,Respiration,Decomposition,None"],
    ["ENV", "Unit 2: Pollution", "Minamata bimari kiske karan hoti hai?", "Mercury", "Lead,Mercury,Cadmium,Iron"],
    ["ENV", "Unit 2: Pollution", "CNG ka mukhya component?", "Methane", "Butane,Methane,Ethane,Propane"],
    ["ENV", "Unit 4: Biodiversity", "India ka National Animal?", "Tiger", "Lion,Tiger,Elephant,Peacock"],
    ["ENV", "Unit 2: Pollution", "E-waste ka example?", "Old Computers", "Vegetable waste,Old Computers,Paper,Wood"],
    ["ENV", "Unit 1: Ecosystem", "Biotic factors ka example?", "Animals", "Air,Water,Soil,Animals"],
    ["ENV", "Unit 2: Pollution", "DDT kya hai?", "Non-biodegradable pollutant", "Fertilizer,Non-biodegradable pollutant,Medicine,None"],
    ["ENV", "Unit 3: Energy", "Biogas ka mukhya strot?", "Cow dung", "Coal,Petrol,Cow dung,None"],
    ["ENV", "Unit 2: Pollution", "Smog kiska mixture hai?", "Smoke and Fog", "Smoke and Dust,Smoke and Fog,Fog and Dust,None"],
    ["ENV", "Unit 1: Ecosystem", "Omnivores kisse kehte hain?", "Jo dono khayein (Plants & Meat)", "Herbivores,Carnivores,Jo dono khayein (Plants & Meat),None"],
    ["ENV", "Unit 2: Pollution", "Earth Day kab hota hai?", "22 April", "22 March,22 April,5 June,1 January"],
    ["ENV", "Unit 2: Pollution", "Particulate matter (PM) kisse juda hai?", "Air Pollution", "Water Pollution,Air Pollution,Land Pollution,None"],
    ["ENV", "Unit 4: Biodiversity", "Deforestation ka matlab?", "Pedo ki katai", "Planting trees,Pedo ki katai,Cleanliness,None"],
    ["ENV", "Unit 5: Rules", "EPA ka full form?", "Environment Protection Act", "Environment Protection Act,Every Person Act,Energy Power Act,None"],
    ["ENV", "Unit 2: Pollution", "Lead (Pb) se kaunsa system damage hota hai?", "Nervous System", "Digestive,Nervous System,Reproductive,None"],
    ["ENV", "Unit 1: Ecosystem", "Ecology kiska study hai?", "Organism and Environment", "Plants only,Organism and Environment,Rocks,None"],
    ["ENV", "Unit 3: Energy", "Geothermal energy kahan se milti hai?", "Earth's Heat", "Sun,Earth's Heat,Wind,Tides"],
    ["ENV", "Unit 2: Pollution", "Chipko Movement kisse juda hai?", "Forest Conservation", "Water,Forest Conservation,Air,Noise"],
    ["ENV", "Unit 2: Pollution", "BOD ka full form?", "Biochemical Oxygen Demand", "Biological Oxygen Demand,Biochemical Oxygen Demand,Both,None"],
    ["ENV", "Unit 4: Biodiversity", "Red Data Book kya hai?", "Endangered species list", "Forest list,Endangered species list,River list,None"],
    ["ENV", "Unit 1: Ecosystem", "Saprophytes kya khate hain?", "Dead matter", "Live plants,Dead matter,Insects,None"],
    ["ENV", "Unit 2: Pollution", "Silicosis kahan hota hai?", "Lungs", "Stomach,Lungs,Heart,Liver"],
    ["ENV", "Unit 3: Energy", "Nuclear energy mein kya use hota hai?", "Uranium", "Coal,Uranium,Iron,Copper"],
    ["ENV", "Unit 2: Pollution", "CFC ka source?", "Refrigerators", "Cars,Refrigerators,Trees,Dust"],
    ["ENV", "Unit 4: Biodiversity", "Endemic species kya hain?", "Jo ek hi area mein milein", "Everywhere,Jo ek hi area mein milein,Extinct,None"],
    ["ENV", "Unit 5: Rules", "Wild Life Protection Act kab aaya?", "1972", "1950,1972,1986,2000"],
    ["ENV", "Unit 1: Ecosystem", "Food Web kya hai?", "Group of food chains", "Single chain,Group of food chains,Plants,None"],
    ["ENV", "Unit 2: Pollution", "Primary pollutant ka example?", "CO", "Ozone,PAN,CO,Smog"],
    ["ENV", "Unit 2: Pollution", "Secondary pollutant ka example?", "Ozone", "CO,NO2,Ozone,SO2"],
    ...
    ["ENV", "Unit 1: Ecosystem", "Ecosystem mein energy flow kaisa hota hai?", "Unidirectional", "Unidirectional,Bidirectional,Multidirectional,None"],
    ["ENV", "Unit 1: Ecosystem", "Desert ecosystem ka example?", "Sahara", "Amazon,Sahara,Himalaya,Ganga"],
    ["ENV", "Unit 2: Pollution", "Photochemical smog mein mukhya hota hai?", "Ozone & PAN", "Oxygen,Ozone & PAN,Nitrogen,Methane"],
    ["ENV", "Unit 2: Pollution", "Blue Baby Syndrome kiske karan hota hai?", "Nitrate", "Lead,Nitrate,Mercury,Fluoride"],
    ["ENV", "Unit 2: Pollution", "Fly Ash kahan se nikalta hai?", "Thermal Power Plants", "Cars,Thermal Power Plants,Forests,Rivers"],
    ["ENV", "Unit 3: Energy", "Solar cell kiska bana hota hai?", "Silicon", "Copper,Silicon,Iron,Aluminium"],
    ["ENV", "Unit 3: Energy", "Tidal energy kahan se milti hai?", "Ocean waves", "Sun,Ocean waves,Earth's heat,Wind"],
    ["ENV", "Unit 4: Biodiversity", "IUCN ka full form?", "International Union for Conservation of Nature", "International Union for Conservation of Nature,India Union,Internal Union,None"],
    ["ENV", "Unit 4: Biodiversity", "Gir National Park kiske liye famous hai?", "Asiatic Lion", "Tiger,Asiatic Lion,Elephant,Rhino"],
    ["ENV", "Unit 5: Rules", "CPCB ka full form?", "Central Pollution Control Board", "Central Pollution Control Board,Central Power Board,City Pollution Board,None"],
    ["ENV", "Unit 2: Pollution", "Sound level ki safety limit (WHO)?", "45-55 dB", "100 dB,45-55 dB,10 dB,None"],
    ["ENV", "Unit 2: Pollution", "Water Act India mein kab pass hua?", "1974", "1974,1981,1986,2000"],
    ["ENV", "Unit 2: Pollution", "Air Act India mein kab pass hua?", "1981", "1974,1981,1986,2000"],
    ["ENV", "Unit 2: Pollution", "Itai-Itai bimari kiske karan hoti hai?", "Cadmium", "Mercury,Lead,Cadmium,Arsenic"],
    ["ENV", "Unit 3: Energy", "Fossil fuels ka alternative?", "Renewable energy", "Coal,Petrol,Renewable energy,None"],
    ["ENV", "Unit 4: Biodiversity", "Endangered species ka example?", "Great Indian Bustard", "Crow,Great Indian Bustard,Dog,Cat"],
    ["ENV", "Unit 1: Ecosystem", "Detritus food chain kahan se shuru hoti hai?", "Dead organic matter", "Living plants,Dead organic matter,Animals,None"],
    ["ENV", "Unit 2: Pollution", "Vermicomposting mein kya use hota hai?", "Earthworms", "Bacteria,Earthworms,Fungi,Virus"],
    ["ENV", "Unit 2: Pollution", "Landfill site ka use?", "Solid waste disposal", "Agriculture,Solid waste disposal,Forestry,None"],
    ["ENV", "Unit 3: Energy", "Ondemand energy source?", "Hydroelectric", "Solar,Wind,Hydroelectric,None"],
    ["ENV", "Unit 1: Ecosystem", "Ecological Pyramid ka concept kisne diya?", "Charles Elton", "Tansley,Charles Elton,Darwin,Odum"],
    ["ENV", "Unit 2: Pollution", "Pyrolysis kya hai?", "Heating in absence of oxygen", "Burning in air,Heating in absence of oxygen,Cooling,None"],
    ["ENV", "Unit 2: Pollution", "Green muffler kisse juda hai?", "Noise Pollution", "Air,Water,Noise Pollution,Soil"],
    ["ENV", "Unit 3: Energy", "Ocean Thermal Energy (OTEC) ka source?", "Temperature difference in sea", "Waves,Temperature difference in sea,Tides,None"],
    ["ENV", "Unit 4: Biodiversity", "Kaziranga National Park kiske liye hai?", "One-horned Rhino", "Lion,Tiger,One-horned Rhino,Deer"],
    ["ENV", "Unit 5: Rules", "ISO 14001 kisse related hai?", "Environmental Management", "Quality,Environmental Management,Safety,Food"],
    ["ENV", "Unit 2: Pollution", "Leachate kya hai?", "Liquid from waste landfill", "Gas,Liquid from waste landfill,Solid,None"],
    ["ENV", "Unit 1: Ecosystem", "Grassland ecosystem mein primary consumers?", "Herbivores", "Lions,Herbivores,Fungi,None"],
    ["ENV", "Unit 2: Pollution", "Global Warming ka mukhya impact?", "Melting of Glaciers", "More rain,Melting of Glaciers,Earthquake,None"],
    ["ENV", "Unit 4: Biodiversity", "Hotspots ka matlab?", "High biodiversity areas", "Cold areas,High biodiversity areas,Volcanoes,None"],
    ["ENV", "Unit 2: Pollution", "Anthropogenic pollution ka matlab?", "Man-made pollution", "Natural,Man-made pollution,Space pollution,None"],
    ["ENV", "Unit 2: Pollution", "BOD badhne par paani mein kya hota hai?", "Oxygen ki kami", "Oxygen ki badhotari,Oxygen ki kami,No change,None"],
    ["ENV", "Unit 3: Energy", "Biogas mein mukhya kya hota hai?", "CH4 and CO2", "H2,CH4 and CO2,CO,Oxygen"],
    ["ENV", "Unit 1: Ecosystem", "Aquatic ecosystem ka example?", "Pond", "Forest,Desert,Pond,Grassland"],
    ["ENV", "Unit 2: Pollution", "Radioactive pollution ka source?", "Nuclear plants", "Cars,Nuclear plants,Agriculture,Trees"],
    ["ENV", "Unit 2: Pollution", "Fluoride pollution se kya damage hota hai?", "Teeth & Bones", "Eyes,Teeth & Bones,Lungs,Heart"],
    ["ENV", "Unit 4: Biodiversity", "Ex-situ conservation example?", "Zoo", "National Park,Zoo,Sanctuary,Hotspot"],
    ["ENV", "Unit 4: Biodiversity", "In-situ conservation example?", "National Park", "Zoo,National Park,Botanical Garden,None"],
    ["ENV", "Unit 5: Rules", "Montreal Protocol kiske liye tha?", "Ozone layer protection", "Global warming,Ozone layer protection,Plastic ban,None"],
    ["ENV", "Unit 2: Pollution", "Lead poisoning se kya hota hai?", "Brain damage", "Lung cancer,Brain damage,Skin disease,None"],
    ["ENV", "Unit 1: Ecosystem", "Trophic level 1 par kaun hota hai?", "Producers", "Producers,Consumers,Decomposers,None"],
    ["ENV", "Unit 2: Pollution", "Biomagnification ka matlab?", "Pollutant concentration badhna", "Population badhna,Pollutant concentration badhna,Size badhna,None"],
    ["ENV", "Unit 2: Pollution", "Sustainable Development ka matlab?", "Vikas bina paryavaran nuksan ke", "Tez vikas,Vikas bina paryavaran nuksan ke,Sirf ped lagana,None"],
    ["ENV", "Unit 1: Ecosystem", "Decomposers ka example?", "Fungi & Bacteria", "Lion,Fungi & Bacteria,Grass,None"],
    ["ENV", "Unit 3: Energy", "Biodiesel kis poudhe se banta hai?", "Jatropha", "Mango,Jatropha,Neem,Peepal"],
    ["ENV", "Unit 5: Rules", "National Green Tribunal (NGT) kab bana?", "2010", "2000,2010,2015,2020"],
    ["ENV", "Unit 2: Pollution", "Eutrophication kahan hota hai?", "Water bodies", "Air,Soil,Water bodies,None"]
    ]
